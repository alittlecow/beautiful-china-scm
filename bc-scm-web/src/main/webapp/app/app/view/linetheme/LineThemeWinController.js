 ...
 * 线路主题管理控制器
 */
Ext.define('app.view.linetheme.LineThemeWinController', {
    extend: 'app.view.base.BaseController',
    alias: 'controller.linethemewin',
    init: function (view) {
        ...
        form.getForm().submit({
            ...
            success: function (fp, o) {
                ...
                if (result.result === 'ok') {
                    ...
                    addWindow.close();
                    Ext.getCmp("center").down('linethemegrid').getStore().load();
                } else {
                ...
                App.Ajax.req({
                    ...
                    success: function (response, options) {
                        ...
                        if (result.result === 'ok') {
                            ...
                            Ext.getCmp("center").down('linethemegrid').getStore().reload();
                        } else {
                            App.Msg.error('', result.msg);
                        }
                    }
